...
Context.prototype.map = function(name, value) {
    // TODO: add ability to pass object and throw error, if variable with given name allready exists
...
Context.prototype.get = function(varName) {
    ...
    var arg = this.variables[varName];
...
function annotate(fn) {
    ...
    if (!fn.$inject) {
        ...
        each(argDecl[1].split(FN_ARG_SPLIT), function(arg) {
...
function mapArguments(argNamesList, context) {
    return map(argNamesList, function(argName) {
